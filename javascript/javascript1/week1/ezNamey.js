const firstWords= ["Spark", "Neo", "Prime", "Wave", "Pulse", "Orbit", "Cloud", "Swift", "Vertex", "Quantum"];
const secondWords = ["Tech", "Solutions", "Hub", "Labs", "Works", "Systems", "Dynamics", "Forge", "Vision", "Edge"];
