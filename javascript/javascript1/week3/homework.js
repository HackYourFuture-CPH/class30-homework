...
function logOutSeriesText()
{
  ...
  for(let i=0; i<seriesDurations.length;i++){
   const moviTime=  ((seriesDurations[i].days)*24*60) + ((seriesDurations[i].hours)*60) +seriesDurations[i].minutes;
    let percentOfLife = (moviTime/lifespan)*100
    console.log(`${seriesDurations[i].title} took ${percentOfLife.toFixed(2)} of my life`)
  }
}
logOutSeriesText();
